      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            _buildSeparator(),
            SizedBox(height: 5),
            MyEditBox.fromDbl(title: 'Расход [W/km]', value: _consumptionWKm, onChange: _getConsumption),
            SizedBox(height: 5),
            MyEditBox.fromDbl(title: 'Время зарядки [min]', value: _chargeTime, onChange: _getChargeTime),
            SizedBox(height: 5),
            _buildSeparator(),
