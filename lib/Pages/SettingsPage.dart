          ...
          child: ListView(
            children: [
              ...
              MyTextBox.fromDbl(
                  ...
                  value: _isAcMode ? ((_acPhases * _acVoltage * _chargerAc) / 1000.0) : _chargerDc * 1.0),
              _buildSeparator(),
              SizedBox(height: 5),
              MyEditBox.fromDbl(title: 'Car Battery [KW]', value: _batteryFullPow, onChange: _getBattery),
              SizedBox(height: 5),
              _buildSeparator(),
              SizedBox(height: 5),
